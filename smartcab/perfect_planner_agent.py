...
from perfect_planner import RoutePlanner
...
class LearningAgent(Agent):
    ...
    def update(self, t):
        ...
        (inputs['oncoming'] == 'forward' or inputs['oncoming'] == 'right'):
            action = None
        ...
        heading = self.env.agent_states[self.env.primary_agent]['heading']
        location = self.env.agent_states[self.env.primary_agent]['location']
        ...
        self.history.append((self.state, heading, location,
                             self.planner.destination, self.planner.delta,
                             action))
